...
export const instance = new Pagination(container, {
  ...
  template: {
    page: '<a href="#" aria-label="pagination" class="tui-page-btn">{{page}}</a>',
    currentPage:
      '<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',
    moveButton: `<a href="#" aria-label="pagination" class="icon tui-page-btn tui-{{type}}">
    ...
    moreButton:
      '<a href="#" aria-label="pagination" class="tui-page-btn tui-{{type}}-is-ellip">' +
